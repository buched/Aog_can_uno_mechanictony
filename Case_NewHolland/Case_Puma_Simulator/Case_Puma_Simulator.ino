//*******************************************
//CNH Demo AC Curve Command Generator
//
//Current Wheel Angle Via Pot A0
//Valve State Via Switch A1
//Steer Engage Command Via Button A2  (Not worked CNH message out yet)
...
byte data1[8] = {15, 96, 1, 255, 255, 255, 255, 255} ;      //Engage Data  (Agco message for now as not worked CNH one out yet)       
...
void setup()
{
  ...
  Serial.println("CNH Tractor Simulator");
...
if (steerState == 1) steerState = 16; // 16 Or 20 = OK
  ...
  if ((millis() - scanLoopMs) > scanLoopInterval) {   // Send data
    ...
    data[6] = 255;
    data[7] = 255;
    CAN0.sendMsgBuf(0x8CACAA08, 1, 8, data);
